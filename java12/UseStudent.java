...
public class UseStudent
{
    ...
    public static void useHashCode()
    {
        //System.out.println("Given Student hashCode() method return integer value on basis of grade of the students of all subjects which is not a good way because it will return same hashcode if grades are same");
        //System.out.println("Wrong way:");
        //System.out.println("There are two student both have same grades but different name, id but still if i search for s1 in HashMap it returns s2 name because it has same hashCode");
        Map<Student, String> map = new HashMap<>();
        
        Student s1 = new Student("anuj", 16, "23mcce16", new int[]{12, 56, 78});
        Student s2 = new Student("anuj", 16, "23mcce16", new int[]{12, 56, 78});
        Student s3 = new Student("chandan", 15, "23mcce15", new int[]{14, 58, 76});
        
        map.put(s1, "anuj1");
        map.put(s2, "anuj2");
        map.put(s3, "chandan");
        System.out.println("Change correct and incorrect way in Student class(hascode methods are comment outed\n");
        System.out.println("map.put(s1, 'anuj1') : "+map.get(s1) + ", HashCode : " + s1.hashCode());
        System.out.println("map.put(s2, 'anuj2') : "+map.get(s2) + ", HashCode : " + s2.hashCode());
        System.out.println("map.put(s3, 'chandan') : "+map.get(s3) + ", HashCode : " + s3.hashCode());
    }
